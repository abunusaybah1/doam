...
export default function BecomeSolverForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // manually append selected skills since checkboxes in a flex grid
    // may not all be captured reliably across browsers
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          required
          rows={5}
          placeholder="e.g. I'm a civil engineer with 8 years of experience in road construction. I have equipment and a team available for community projects..."
      ...
      >
        {loading ? "Registering..." : "Register as a solver →"}
      </button>

      <p className="text-[0.75rem] text-umber leading-relaxed">
        You can update your solver profile anytime from your dashboard.
        Registering doesn&apos;t lock you in — you choose which problems to
        claim and when.
      </p>
    </form>
  );
